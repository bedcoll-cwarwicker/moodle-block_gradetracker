...
$string['errors:import:tg:aspupdate'] = 'Could not update Aspirational Grade for %s on qualification %s, due to an unknown error';
$string['errors:import:tg:wtgupdate'] = 'Could not calculate Weighted Target Grade for %s on qualification %s';
...
$string['logs'] = 'Logs';
$string['log:GT_LOG_DETAILS_UPDATED_USER_CRIT'] = '<table><tr><td>Qualification:</td><td>%s</td></tr><tr><td>Unit:</td><td>%s</td></tr><tr><td>Criterion:</td><td>%s</td></tr><tr><td>Student:</td><td>%s</td></tr><tr><td>Value:</td><td>%s</td></tr>%s</table>';
$string['log:GT_LOG_DETAILS_UPDATED_USER_UNIT'] = '<table><tr><td>Qualification:</td><td>%s</td></tr><tr><td>Unit:</td><td>%s</td></tr><tr><td>Student:</td><td>%s</td></tr><tr><td>Value:</td><td>%s</td></tr></table>';
$string['log:GT_LOG_DETAILS_UPDATED_USER_ASS'] = '<table><tr><td>Qualification:</td><td>%s</td></tr><tr><td>Assessment:</td><td>%s</td></tr><tr><td>Student:</td><td>%s</td></tr><tr><td>Grade:</td><td>%s</td></tr><tr><td>CETA:</td><td>%s</td></tr></table>';
$string['log:GT_LOG_DETAILS_UPDATED_USER_ATT'] = '<table><tr><td>Qualification:</td><td>%s</td></tr>%s<tr><td>Student:</td><td>%s</td></tr><tr><td>Attribute:</td><td>%s</td></tr><tr><td>Value:</td><td>%s</td></tr></table>';
$string['log:GT_LOG_DETAILS_UPDATED_USER_RANGE'] = '<table><tr><td>Qualification:</td><td>%s</td></tr><tr><td>Unit:</td><td>%s</td></tr><tr><td>Criterion:</td><td>%s</td></tr><tr><td>Range:</td><td>%s</td></tr><tr><td>Observation Number:</td><td>%s</td></tr><tr><td>Student:</td><td>%s</td></tr><tr><td>Value:</td><td>%s</td></tr></table>';
$string['log:GT_LOG_DETAILS_UPDATED_USER_GRADE'] = '<table><tr><td>Qualification:</td><td>%s</td></tr><tr><td>Student:</td><td>%s</td></tr><tr><td>Type:</td><td>%s</td></tr><tr><td>Grade:</td><td>%s</td></tr></table>';
$string['log:GT_LOG_DETAILS_IMPORTED_GRID'] = '<table><tr><td>Qualification:</td><td>%s</td></tr>%s%s</table>';
$string['log:GT_LOG_DETAILS_SAVED_CONFIG'] = '<pre>%s</pre>';
