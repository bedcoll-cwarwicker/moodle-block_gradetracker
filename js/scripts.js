...
function gtToggleEditGrades(type, qualID){
    ...
    if (type == 'target'){
        var viewClass = '.stud_target_grade_view_'+qualID;
        var editClass = '.stud_target_grade_edit_'+qualID;
    } else if (type == 'aspirational'){
        var viewClass = '.stud_aspirational_grade_view_'+qualID;
        var editClass = '.stud_aspirational_grade_edit_'+qualID;
    } else {
        return false;
    }
