...
class Assessment {
    ...
    public function updateAttribute($attribute, $value, $qualID = false, $studentID = false){
        ...
        // Log the action
        $Log = new \GT\Log();
        $Log->addLog(\GT\Log::GT_LOG_CONTEXT_GRID, \GT\Log::GT_LOG_DETAILS_UPDATED_USER_ATT, array(
            "attributes" => array(
                "qualID" => $this->qualID,
                "unitID" => $this->unitID,
                "assID" => $this->id,
    ...
    public function deleteAttribute($attribute, $qualID = false, $studentID = false){
        ...
        return $DB->delete_records("bcgt_assessment_attributes", array("qualid" => $qualID, "userid" => $studentID, "attribute" => $attribute));
    ...
    public function saveUser(){
        ...
        // Log the event
        $Log = new \GT\Log();
        $Log->addLog(\GT\Log::GT_LOG_CONTEXT_GRID, \GT\Log::GT_LOG_DETAILS_UPDATED_USER_ASS, array(
            "attributes" => array(
                "qualID" => $this->qualification->getID(),
                "assID" => $this->id,
                "studentID" => $this->student->id,
