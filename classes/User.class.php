...
class User {
    ...
    public function canAccessQual($qualID, $role){
        ...
        return ($this->isOnQual($qualID, $role) || \gt_has_capability('block/gradetracker:view_all_quals'));
    ...
    public function canEditQual($qualID){
        ...
        return (($this->isOnQual($qualID, "STAFF") && \gt_has_capability('block/gradetracker:edit_grids')) || \gt_has_capability('block/gradetracker:edit_all_quals'));
    ...
    public function canEditUnit($qualID, $unitID){
        ...
        return ( ($this->isOnQualUnit($qualID, $unitID, "STAFF") && \gt_has_capability('block/gradetracker:edit_grids')) || \gt_has_capability('block/gradetracker:edit_all_quals'));
    ...
    public function hasCapability($cap){
        $result = \gt_has_capability($cap, false, false, $this);
        return $result;
    }
    ...
    public function setUserGrade($type, $grade, $params){
        ...
        // Log the action
        $Log = new \GT\Log();
        $Log->addLog(\GT\Log::GT_LOG_CONTEXT_GRID, \GT\Log::GT_LOG_DETAILS_UPDATED_USER_GRADE, array(
            "attributes" => array(
