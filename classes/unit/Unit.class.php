...
class Unit {
    ...
    public function hasNoErrors(){
        ...
        $check = $DB->get_record("bcgt_units", array("name" => $this->name, "unitnumber" => $this->unitNumber, "code" => $this->code, "structureid" => $this->structureID, "levelid" => $this->levelID, "deleted" => 0));
